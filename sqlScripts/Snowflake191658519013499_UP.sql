CREATE TABLE "temporary_blunder_tracker" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "description" varchar NOT NULL, "role" varchar(19), "last_blunder" date, "message" varchar(19) NOT NULL, "channel" varchar(19) NOT NULL);
...
CREATE TABLE "temporary_tasks" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar NOT NULL, "description" varchar(2048) NOT NULL, "creator" varchar(19) NOT NULL, "assignees" text NOT NULL, "status" varchar);
...
CREATE TABLE "temporary_moderation_notes" ("member" varchar(19) PRIMARY KEY NOT NULL, "body" varchar(1024) NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), "updaters" text NOT NULL);
...
CREATE TABLE "temporary_banned_words" ("word" varchar(19) PRIMARY KEY NOT NULL, "punishment_type" varchar, "reason" varchar(1024), "duration" integer, "exception" boolean NOT NULL DEFAULT (0));
...
CREATE TABLE "temporary_suspicious_users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "userId" varchar(19) NOT NULL, "submitterId" varchar(19) NOT NULL, "messageId" varchar(19) NOT NULL, "denied" boolean NOT NULL DEFAULT (0), "approved" boolean NOT NULL DEFAULT (0), "moderatorId" varchar(19), "reason" text, "evidence" text NOT NULL, "deletedAt" datetime, "threadId" varchar(19));
...
CREATE TABLE "temporary_advanced_builders" ("builder" varchar(19) PRIMARY KEY NOT NULL, "given_at" datetime NOT NULL DEFAULT (datetime('now')), "role_name" varchar NOT NULL DEFAULT ('ADVANCED_BUILDER'));
...
CREATE TABLE "temporary_timed_punishments" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "member" varchar(19) NOT NULL, "type" varchar NOT NULL, "length" integer NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')));
...
CREATE TABLE "temporary_reminders" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "channel" varchar(19) NOT NULL, "message" varchar(1024) NOT NULL, "interval" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "next_fire_date" integer NOT NULL);
...
CREATE TABLE "temporary_moderation_menus" ("member" varchar(19) PRIMARY KEY NOT NULL, "message" varchar(19) NOT NULL, "message_text" varchar(2000) NOT NULL, "punishments" text NOT NULL, "offenses" integer NOT NULL, "current_word" varchar NOT NULL);
