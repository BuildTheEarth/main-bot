...
export default async function createPlaceholder(
    ...
    if (
        ...
        if (info.subcommand === "add") {
            ...
            client.log(client.placeholder.cache[info.name + " " + info.language], "add", interaction.user)
            ...
            if (info.existingPlaceholder.body === body)
                ...
                client.log(client.placeholder.cache[info.name + " " + info.language], "edit", interaction.user)
        }
    }
}
